...
# def get_deeplabv3_mobile(backbone='resnet50', local_rank=None, pretrained=None, pretrained_base=True, num_class=19, **kwargs):
def get_deeplabv3_mobile(backbone='mobilenetv2', local_rank=None, pretrained=None, pretrained_base=True, num_class=19, **kwargs):
